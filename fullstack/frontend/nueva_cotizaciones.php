...
require_once("/var/www/html/Simulacro/fullstack/backend/models/constructoras.php");
require_once("/var/www/html/Simulacro/fullstack/backend/models/empleados.php");
require_once("/var/www/html/Simulacro/fullstack/backend/models/productos.php");
...
<main> 
    <form action="/Simulacro/fullstack/backend/config/addCotizacion.php" method="post" class="form-container">
    <div class="form-div">
